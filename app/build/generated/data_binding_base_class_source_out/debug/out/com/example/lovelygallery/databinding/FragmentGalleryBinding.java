...
public final class FragmentGalleryBinding implements ViewBinding {
  ...
  @NonNull
  public final ExtendedFloatingActionButton fabAddPhoto;

  @NonNull
  public final RecyclerView recyclerView;

  private FragmentGalleryBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ExtendedFloatingActionButton fabAddPhoto, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fabAddPhoto;
      ExtendedFloatingActionButton fabAddPhoto = ViewBindings.findChildViewById(rootView, id);
      if (fabAddPhoto == null) {
        break missingId;
      }
      ...
      return new FragmentGalleryBinding((CoordinatorLayout) rootView, fabAddPhoto, recyclerView);
    }
