...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  @NonNull
  public final Chip tvPhotoCount;
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Chip tvPhotoCount = ViewBindings.findChildViewById(rootView, id);
      if (tvPhotoCount == null) {
        break missingId;
      }

      return new ItemCategoryBinding((MaterialCardView) rootView, ivCategoryIcon,
          tvCategoryDescription, tvCategoryName, tvPhotoCount);
    }
